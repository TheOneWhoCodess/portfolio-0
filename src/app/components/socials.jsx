	...
	return (
		<div id="socials" className="w-full md:m-auto md:col-span-5">
			<div className="flex justify-center items-center gap-5 w-full md:justify-center xl:gap-10">
				<a
					href="https://www.linkedin.com/in/raushan-singh26"
					target="_blank"
					rel="noreferrer"
				...
				<a href="https://github.com/TheOneWhoCodess" target="_blank" rel="noreferrer">
					<SiGithub
						className="text-gray-200 cursor-pointer hover:-translate-y-1 ease-in-out duration-300 xl:size-12"
						size={30}
					/>
				</a>
				<a href="https://x.com/Sani_Singh26" target="_blank" rel="noreferrer">
					<SiX
						className="text-gray-200 cursor-pointer hover:-translate-y-1 ease-in-out duration-300 xl:size-12"
						size={30}
					/>
